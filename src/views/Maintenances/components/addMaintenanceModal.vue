              ...
              <div class="grid grid-cols-1 gap-y-4 gap-x-4 sm:grid-cols-2">
                ...
                <div v-if="selectedAsset">
                  ...
                  <input
                    ...
                    disabled
                    class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-zinc-500 focus:border-zinc-500 dark:bg-gray-800 dark:border-gray-600 dark:text-white"
                  />
                </div>
                <div v-if="selectedAsset">
...
// Debounce pencarian untuk performa
...
watch(
  ...
  (val) => {
    ...
    debounceTimeout = setTimeout(() => {
      // Jika input berubah dan tidak sesuai pilihan asset, reset asset_id
      const isSelected =
...
const selectedAsset = computed(() => {
  return assets.value.find((a) => a.id === form.value.asset_id) || null
})
